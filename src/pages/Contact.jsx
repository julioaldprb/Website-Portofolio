...
>
<h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-10 text-center text-blue-700">
Contact Me
</h2>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
    ...
    <div className="space-y-6 text-base sm:text-lg">
      ...
      <div className="space-y-5 text-gray-800">
        <div className="flex items-center gap-3">
          ...
          <a href="mailto:juliopurba647@mhs.unimed.ac.id" className="hover:underline break-all">
    ...
    <form
      ...
      method="POST"
      className="space-y-4 bg-white shadow-md rounded-2xl p-5 sm:p-6"
    >
      <input
        type="text"
        name="name"
      ...
      <button
        type="submit"
        className="inline-flex items-center justify-center gap-2 px-6 py-3 text-sm sm:text-base bg-blue-600 text-white rounded-full font-medium hover:bg-blue-700 transition"
      >
